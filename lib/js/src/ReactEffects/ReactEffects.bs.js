...
function ReactEffects(Props) {
  ...
  return React.createElement("div", undefined, React.createElement("ul", undefined, React.createElement("li", undefined, "Demo shows which effect is called as a result of a change in a state/render"), React.createElement("li", undefined, "All effects are called atleast once due to the initial render of the component"), React.createElement("li", undefined, "Check code for different implementations of effects")), React.createElement("br", undefined), React.createElement("button", {
